<div class="container" style="color: black !important;">
  <div class="row">
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="modal-2">
              ...
              <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9" style="border-left:1px solid lightgray;">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="order-status">
                    ...
                    <br><br>
                    <i class="fa fa-cogs" aria-hidden="true" title="В очереди печати"></i>&nbsp;&nbsp;В очереди печати - заказ отправлен в производство, ждет своей очереди.<br><br>
